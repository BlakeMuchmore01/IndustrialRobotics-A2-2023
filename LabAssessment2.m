        ...
        function HitSelected(app, toDealer)
            ...
            while counter <= size(qMatrixDobot,1)
                ...
                if LabAssessment2.LightCurtainCheck(app.hand.handModels{1}) && ...
                        app.continuePressed && ~app.dobotMagician.CheckCollision(app.hand.handModels{2}) && ~app.auboI5.CheckCollision(app.hand.handModels{2}) % && ~app.auboI5.isCollision() && 
            ...
            while counter <= size(qMatrixDobot,1)
                ...
                % on, light curtain safe, no collisions)
                if LabAssessment2.LightCurtainCheck(app.hand.handModels{1}) && ...
                        app.continuePressed && ~app.dobotMagician.CheckCollision(app.hand.handModels{2}) && ~app.auboI5.CheckCollision(app.hand.handModels{2}) % && ~app.auboI5.isCollision() && ~app.dobotMagician.isCollision() 
