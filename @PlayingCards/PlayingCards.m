...
classdef PlayingCards < RobotBaseClass
    ...
    properties (Access = public, Constant)
        cardCount = 21; % Default number of playing cards to create/plot
        ...
        cardFinalPositions = [0.3827 0.35 0.21; 0.3827 0.41 0.21; 0.3827 0.47 0.21; 0.3827 0.53 0.21; 0.3827 0.59, 0.21; ...
                              0.5327 -0.12 0.21; 0.5327 -0.06 0.21; 0.5327 0 0.21; 0.5327 0.06 0.21; 0.5327 0.12, 0.21; ...
                              0.3827 -0.58 0.21; 0.3827 -0.52 0.21; 0.3827 -0.46 0.21; 0.3827 -0.40 0.21; 0.3827 -0.34, 0.21];
    ...
    methods
        ...
        function self = PlayingCards(baseTr,L)
            ...
            for i = 1:self.cardCount
                ...
                self.cardInitialTransforms{i} = self.cardModels{i}.base.T; % Storing card initial transforms for later use
